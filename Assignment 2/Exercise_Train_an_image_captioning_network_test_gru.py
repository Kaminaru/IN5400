...
if __name__ == '__main__':
    ...
    modelParam = {
        ...
        'img_dir': 'loss_images_test/', # does not work because plotter have own name for the folder
        'modelsDir': 'storedModels_test/',
        'modelName': 'model_1/',  # name of your trained model    # change name run another task
        'restoreModelLast': 0,
        'restoreModelBest': 0,
        'modeSetups': [['train', True], ['val', True]],
        'inNotebook': False,  # If running script in jupyter notebook
        'inference': False # restore model
    }
    ...
    config = {
        ...
        'cellType':  'GRU' #'GRU'  # RNN or GRU or LSTM
    }
